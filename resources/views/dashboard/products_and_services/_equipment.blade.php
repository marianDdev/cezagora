@if(is_null($user->company) || ($user->stripe_account_enabled == false))
    <div class="items-center bg-gray-200 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a role="link" aria-disabled="true">
            <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{ url('/images/dashboard/equipment.png') }}" />
        </a>
        <div class="p-5">
            <a role="link" aria-disabled="true">
...
@else
    ...
    <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a href="{{ route('my_equipment') }}">
            <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{ url('/images/dashboard/equipment_2.png') }}" />
        </a>
        <div class="p-5">
            @if($count === 0)

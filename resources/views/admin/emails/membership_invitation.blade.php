            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST"
                          action="{{ route('membership_invitation.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div
                            ...
                            <div class="p-5">
                                @csrf
                                <input
                                    class="mb-2 block text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                    type="file" name="invitation">
                                <button type="submit"
                ...
                <tbody>
                    @foreach($invitations as $invitation)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                {{ \Carbon\Carbon::parse($invitation->updated_at)->format('Y-m-d H:i:s') }}
                            </td>
                        </tr>
                    @endforeach

                                    ...
                                    <div class="space-y-6">
                                        <div class="flex items-center">
                                            ...
                                            <label for="filter-mobile-category-0"
                                                   class="ml-3 min-w-0 flex-1 text-gray-500">Discover our entire list of ingredients.</label>
                                        </div>
                                        <div class="flex items-center">
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex items-center">
                                            ...
                                            <label for="filter-category-0"
                                                   class="ml-3 text-sm text-gray-600">Discover our entire list of ingredients.</label>
                                        </div>
                                        <div class="flex items-center">

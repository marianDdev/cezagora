<div
    ...
    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Equipment</h2>
    ...
    <a href="{{ route('equipment.index') }}"
       class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Go to equipment page

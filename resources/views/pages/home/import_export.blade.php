<div
    ...
    <h2 class="text-red-400 dark:text-white text-3xl font-extrabold mb-2">Import & Export </h2>
    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img src="https://cezagora.fra1.cdn.digitaloceanspaces.com/homepage/import_export.png">
    </div>

<div
    ...
    <h2 class="text-red-400 dark:text-white text-3xl font-extrabold mb-2">Market research</h2>
    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img src="https://cezagora.fra1.cdn.digitaloceanspaces.com/homepage/market_research.png">
    </div>

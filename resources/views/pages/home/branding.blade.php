<div
    ...
    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Branding</h2>
    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img src="{{ url('/images/homepage/branding.png') }}">
    </div>
    ...
    <a href="{{ route('services.index', ['type' => \App\Services\Service\ServicesServiceInterface::BRANDING]) }}"
       class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Go to branding specialists list

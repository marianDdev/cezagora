@if(is_null($company))
    <div class="items-center bg-gray-200 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a role="link" aria-disabled="true">
            <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{ url('/images/dashboard/qualifications.jpeg')}}" alt="qualifications" />
        </a>
        <div class="p-5">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg flex justify-center items-center">
                    <form method="POST" action="{{ route('qualification.store') }}" class="w-4/5 ">
                        ...
                        <div class="mb-6">
                            <x-input-label for="verification_link"
                                           :value="__('URL for credential’s authenticity verification.')" />
                            <x-text-input id="verification_link" type="url" name="verification_link"
                                          :value="old('verification_link')" autofocus
                                          autocomplete="verification_link"
                                          placeholder="Eg: https://www.example.com/my_qualification_id" />
                            <x-input-error :messages="$errors->get('verification_link')" class="mt-2" />
                        </div>
                        <div class="mb-6">
                            <x-input-label for="url"
                                           :value="__('URL of credential document digital copy (if available).')" />
                            <x-text-input id="url" type="url" name="url" :value="old('url')" autofocus
                                          autocomplete="url"
                                          placeholder="Eg: https://www.example.com/my_qualification.pdf" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="additional_info" type="text" name="additional_info"
                                          ...
                                          placeholder="E.g: Specific conditions of certification" />

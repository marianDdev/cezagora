<div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
    ...
    <!-- Modal toggle -->
    <button data-modal-target="add-packaging-manually" data-modal-toggle="add-packaging-manually"
    ...
    <!-- Main modal -->
    <div id="add-packaging-manually" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button"
                        ...
                        data-modal-hide="add-packaging-manually"
                >
                ...
                <div class="px-4 py-4 lg:px-8">
                    <form class="space-y-6" method="POST" action="{{ route('packaging.store') }}">
                        ...
                        <button type="submit"
                                ...
                                data-modal-hide="!$errors->any() ? 'add-packaging-manually' : 'do not close'"
                        >

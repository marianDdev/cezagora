<div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
    ...
    <!-- Main modal -->
    <div id="add-ingredient-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button"
                        ...
                        data-modal-hide="add-ingredient-modal"
                >
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('ingredient.store') }}">
                        ...
                        <button type="submit"
                                ...
                                data-modal-hide="!$errors->any() ? 'add-ingredient-modal' : 'do not close'"
                        >
                            Create
                        </button>
                    </form>

            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('ingredient.store') }}">
                        ...
                        <div>
                            <label for="available_at" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Availability date</label>
                            <input type="text" name="available_at" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="2023-09-01">

    ...
    <div
        ...
        @if($authUserOwnsIngredient === false)
            <form action="{{ route('ingredient.order-item.store') }}" method="post">
                ...
                <button type="submit"
                        class="text-white bg-green-400 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2"
                >

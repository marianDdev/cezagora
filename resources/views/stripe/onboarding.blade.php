<x-guest-layout>
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-red-400">Please Connect with Stripe to set up your payments account before managing your products and services.</h5>
